      ...
      <section class="hero section-anchor" id="top">
        ...
        <svg class="hero__clip-defs" width="0" height="0" aria-hidden="true" focusable="false">
          <defs>
            ...
            <?php // スマホは幅が狭く縦に長いため、同じ割合でも波が急に見える。振幅を抑えた別パスを使う ?>
            <clipPath id="aiji-hero-clip-sp" clipPathUnits="objectBoundingBox">
              <path d="M0,0L1,0L1,.909C.958,.912 .833,.931 .750,.930C.667,.929 .583,.901 .500,.901C.417,.900 .333,.925 .250,.926C.167,.927 .042,.912 .000,.909Z">
                <animate
                  attributeName="d"
                  dur="32s"
                  repeatCount="indefinite"
                  values="M0,0L1,0L1,.909C.958,.912 .833,.931 .750,.930C.667,.929 .583,.901 .500,.901C.417,.900 .333,.925 .250,.926C.167,.927 .042,.912 .000,.909Z;M0,0L1,0L1,.922C.958,.919 .833,.904 .750,.905C.667,.906 .583,.925 .500,.926C.417,.927 .333,.910 .250,.909C.167,.908 .042,.916 .000,.917Z;M0,0L1,0L1,.901C.958,.904 .833,.920 .750,.922C.667,.923 .583,.907 .500,.909C.417,.911 .333,.935 .250,.934C.167,.933 .042,.910 .000,.905Z;M0,0L1,0L1,.909C.958,.912 .833,.931 .750,.930C.667,.929 .583,.901 .500,.901C.417,.900 .333,.925 .250,.926C.167,.927 .042,.912 .000,.909Z"
                />
              </path>
            </clipPath>
          </defs>
