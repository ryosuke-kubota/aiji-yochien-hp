    ...
    <header class="site-header" data-header>
      ...
      <div class="site-menu" id="site-menu" data-menu>
        <nav class="site-nav" id="site-nav" aria-label="主なメニュー" data-nav>
          ...
          <?php endforeach; ?>
          <a href="<?php echo aiji_page_url( 'recruit' ); ?>"<?php echo is_page( 'recruit' ) ? ' aria-current="page"' : ''; ?>>採用情報</a>
        </nav>

        <div class="header-actions">
          <a class="header-pill header-pill--green" href="<?php echo aiji_page_url( 'tour' ); ?>">園見学・体験の方へ<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2.5" y="3" width="11" height="10.5" rx="2"/><path d="M5.5 1.5v3M10.5 1.5v3M5.5 8.5l1.8 1.8 3.2-3.2"/></svg></a>
          <a class="header-pill header-pill--pink" href="<?php echo aiji_page_url( 'contact' ); ?>">お問い合わせ<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="1.5" y="3" width="13" height="10" rx="2"/><path d="M2.5 4.5 8 9l5.5-4.5"/></svg></a>
        </div>
      </div>
