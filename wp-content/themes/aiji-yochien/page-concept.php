    ...
    <main class="subpage-main">
      ...
      <section class="page-section soft-panel cream-panel" id="regular">
        ...
        <div class="lesson-grid">
          <article class="lesson-card">
            <img src="<?php echo aiji_asset( 'images/philosophy-bubbles-circle.png' ); ?>" alt="英語レッスンのイメージ">
            <h3>英語レッスン<span class="tag tag--blue">イチオシ</span></h3>
            <p>物の名前・歌・色カードを使って覚える、当園自慢のレッスンです。</p>
          </article>
          <article class="lesson-card">
            <img src="<?php echo aiji_asset( 'images/hero-children-running.png' ); ?>" alt="体育レッスンのイメージ">
            <h3>体育レッスン<span class="tag tag--green">イチオシ</span></h3>
            <p>なわとび・鉄棒・トランポリンで楽しみながら、たくましい体をつくります。</p>
          </article>
          <article class="lesson-card">
            <img src="<?php echo aiji_asset( 'images/philosophy-craft-circle.png' ); ?>" alt="音楽レッスンのイメージ">
            <h3>音楽レッスン</h3>
            <p>楽器を使ってリズム感を養い、みんなで合わせる楽しさを経験します。</p>
          </article>
          <article class="lesson-card">
            <img src="<?php echo aiji_asset( 'images/card-parenting.png' ); ?>" alt="作文レッスンのイメージ">
            <h3>作文レッスン</h3>
            <p>今覚えている言葉で作文をつくり、表現する楽しさを育てます。</p>
          </article>
          <article class="lesson-card">
            <img src="<?php echo aiji_asset( 'images/card-prekindergarten.png' ); ?>" alt="数のレッスンのイメージ">
            <h3>数のレッスン</h3>
            <p>かんたんな足し算と引き算のおけいこで、学びの芽を育てます。</p>
          </article>
          <article class="lesson-card">
            <img src="<?php echo aiji_asset( 'images/card-admission.png' ); ?>" alt="愛児農園のイメージ">
            <h3>愛児農園</h3>
      ...
      <section class="page-section" id="after">
        ...
        <div class="event-grid">
          <article class="event-card"><h3>預かり保育</h3><p>早朝保育7:30から、延長保育は18:30まで。長時間保育に対応します。</p></article>
          <article class="event-card"><h3>送迎バス</h3><p>送迎バスを運行。ご自宅への搬送サービスもあります。</p></article>
        </div>
      </section>
      ...
      <section class="page-section soft-panel split-section" id="lunch">
        ...
        <figure class="photo-card">
          <img src="<?php echo aiji_asset( 'images/card-parenting.png' ); ?>" alt="お弁当や食育のイメージ">
        </figure>
      </section>
    </main>
